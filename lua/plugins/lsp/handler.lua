...
local function lsp_keymaps(bufnr)
	...
	local function b_keymap(mode, lhs, rhs, options)
		local _opts = options or default_opts
		set_keymap(bufnr, mode, lhs, rhs, _opts)
	end
	...
	b_keymap("x", "<leader>rca", ":<c-u>Lspsaga range_code_action<CR>")
	b_keymap("n", "K", "<cmd>Lspsaga hover_doc<CR>")
	b_keymap("n", "<space>jl", "<cmd>Lspsaga show_line_diagnostics<CR>")
	b_keymap("n", "<space>jj", "<cmd>Lspsaga diagnostic_jump_next<CR>")
	b_keymap("n", "<space>jk", "<cmd>Lspsaga diagnostic_jump_prev<CR>")
